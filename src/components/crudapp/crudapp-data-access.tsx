import { getCrudappProgramId, getGreetInstruction } from '@project/anchor'
...
export function useGetProgramAccountQuery() {
  ...
  return useQuery({
    ...
    queryFn: () => client.rpc.getAccountInfo(getCrudappProgramId(cluster.id)).send(),
  })
}

export function useGreetMutation() {
  const programAddress = useCrudappProgramId()
